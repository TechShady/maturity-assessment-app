...
export const DtExecutive = () => {
  ...
  if (history.length === 0) {
    return (
      <div className="exec-container" style={{ textAlign: "center", paddingTop: 80 }}>
        <h2>No Data Yet</h2>
        <p style={{ opacity: 0.6 }}>Complete DT Maturity assessments to see the executive summary.</p>
  ...
  return (
    <div className="exec-container">
      ...
      <div className="exec-header">
        <h1>DT Maturity Executive Summary</h1>
        <p>Organization-wide Dynatrace maturity overview based on {latestPerUser.length} assessor{latestPerUser.length !== 1 ? "s" : ""}</p>
      </div>
        ...
        <div className="exec-section">
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <RadarChart
              ...
              values={dynatraceMaturityCategories.map((c) => orgStats.categoryScores[c.id] || 0)}
              size={300}
              color={overallColor}
            />
          </div>
